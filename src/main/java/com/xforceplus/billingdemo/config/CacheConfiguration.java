package com.xforceplus.billingdemo.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.xforceplus.billingdemo.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.xforceplus.billingdemo.repository.UserRepository.USERS_BY_EMAIL_CACHE);
